%% Simulation model of DC AGI (aka. DC-coupled AC-output DVPP)
% The model reproduces the result (partial) in the paper below.
...
T_des_fp_agg = 1/(T_des_vdcf*T_des_agg);
